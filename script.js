...
function downloadResume(format) {
  ...
  if (format == "pdf") {
    link.href = "assets/resume/NompumeleloMbhense_CV.pdf";
    link.download = "NompumeleloMbhense_CV.pdf";
  }
...
function previewResume() {
  ...
  const previewWindow = window.open(
    "assets/resume/NompumeleloMbhense_CV.pdf",
    "_blank"
  );
  if (!previewWindow) {
    showNotification("Please allow popups to preview the resume", "warning");
  }
}
